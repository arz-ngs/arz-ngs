...
public interface ServiceInstanceRepository {
	...
	ServiceInstance getServiceInstance(ServiceInstanceName serviceInstanceName, Service service, Host host,
	...
	List<ServiceInstance> getServiceInstances(ServiceName service, EnvironmentName environment);
	 ...
	 * @param newStatus
	 */
	void addServiceInstance(Host newHost, Service newService, Environment newEnvironment, Script newScript,
			ServiceInstanceName newServiceInstanceName, Status newStatus, String information);
